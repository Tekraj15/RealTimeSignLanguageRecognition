...
function App() {
  ...
  const runCoco = async () => {
    // 3. TODO - Load network 
    //https://capstonetfod.s3.jp-tok.cloud-object-storage.appdomain.cloud/model.json
    const net = await tf.loadGraphModel('https://ram6174.s3.jp-tok.cloud-object-storage.appdomain.cloud/model.json')
